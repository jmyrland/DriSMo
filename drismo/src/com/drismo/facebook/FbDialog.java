...
import com.drismo.R;
import com.drismo.facebook.Facebook.DialogListener;
...
public class FbDialog extends Dialog {
    ...
    static final String FB_ICON = "ic_dialog_facebook.png";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSpinner.setIndeterminateDrawable(getContext().getResources().getDrawable(R.anim.loading));
